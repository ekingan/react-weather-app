...
var App = React.createClass({
	...
	handleSearch: function (search) {
		HTTP.get('/data/2.5/forecast?q=' + search + '&units=imperial&appid=389fe5cd1ef36b657382a7ef465553f2').then(function (data) {
			this.setState({ weather: [data] });
		}.bind(this));
	},
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'panel-heading', background: '#817871' },
...
},{"../services/server":175,"./CurrentWeatherPanel.jsx":170,"./FutureWeatherPanel.jsx":172,"./SearchBox.jsx":173,"react":167}],170:[function(require,module,exports){
var React = require('react');
...
var CurrentWeatherPanel = React.createClass({
  displayName: "CurrentWeatherPanel",


  render: function () {
    return React.createElement(
      "div",
      { className: "container", style: todayStyle },
      React.createElement(
        "div",
        { className: "row" },
        React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: iconStyle },
            React.createElement("i", { className: evalIcon(this.props.icon) })
          ),
          React.createElement(
            "div",
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "i",
          { className: evalIcon(this.props.icon) },
          " "
        )
      ),
      React.createElement(
...
var FutureWeatherPanel = React.createClass({
  displayName: 'FutureWeatherPanel',
    ...
    var futureWeatherItem = this.props.tempList.map(function (item, key) {
      if (item.dt_txt.substring(11, 13) == "18") {
        return React.createElement(
          'div',
          { key: key },
          React.createElement(FutureWeatherItem, {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-xs-2', align: 'pull-right' },
						React.createElement(
							'button',
							null,
							React.createElement('i', { style: searchIcon, className: 'ion-android-search' })
						)
					)
				)
			)
...
},{"./components/App.jsx":169,"react":167,"react-dom":29}],175:[function(require,module,exports){
